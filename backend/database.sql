...
('Soirée d''intégration BDE', 'Le Bureau Des Étudiants vous invite à la soirée d''intégration du semestre. Au programme : blind test, DJ set et buffet.', 'bde', '2026-04-15'),
('Conférence IA & Métiers du Numérique', 'Des professionnels du secteur tech viennent présenter leurs parcours et les opportunités d''alternance.', 'general', '2026-04-08');
